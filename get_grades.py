...
async def _get_grades_page(sess: aiohttp.ClientSession, username: str, csrf: str) -> str:
    async with sess.post(vtop_gradeHistory_url, data=get_gradeHistory_payload(username, csrf)) as req:
