...
vtop_timetable_url = f"{vtop_base_url}processViewTimeTable"
vtop_process_timetable_url = f"{vtop_base_url}processViewTimeTable"
vtop_semID_list_url = "{vtop_base_url}academics/common/StudentAttendance"
...
vtop_examSchedule_url = "{vtop_base_url}examinations/StudExamSchedule"
